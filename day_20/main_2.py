...
def main():
    ...
    for line in open("inp.txt", "r"):
        node = Node(counter, int(line.strip()) * decryption_key, prev)
        counter += 1
    ...
    for _ in range(0, 10):
        for i in range(1, counter):
            ...
            if node.value != 0:
                ...
                # From the example it was not clear enough, at least for me, that the number has to be removed from the list
